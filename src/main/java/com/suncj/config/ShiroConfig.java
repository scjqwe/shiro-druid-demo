...
import com.suncj.realm.UserRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/user/manage", "authc,perms[user:manage]");
	...
	@Bean
	public SessionManager sessionManager(UserSessionDao sessionDao, SimpleCookie sessionIdCookie, SessionListener sessionListener, SessionFactory sessionFactory) {
